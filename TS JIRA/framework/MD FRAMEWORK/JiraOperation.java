...
public class JiraOperation {
    ...
    public List<String> downloadEmbeddedImages(JiraTestStep step) throws IOException {
        ...
        for (String imageUrl : imageUrls) {
            if (imageUrl != null && !imageUrl.isEmpty()) {
			    String imagePath = downloadImage(jiraBaseURL, imageUrl);
    ...
    // Utility method to extract the file name from a URL
